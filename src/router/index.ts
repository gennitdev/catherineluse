...
const DEFAULT_DESCRIPTION =
  'Software engineer with a frontend focus, building reliable web apps with Vue, React, TypeScript, and Node.js.'
      ...
      children: [
        {
          ...
          meta: {
            ...
            description:
              "Catherine Luse's professional history as a software engineer, including work at HeartFlow, Flightcrew, and SUSE."
          }
        },
        {
          path: 'fun',
          ...
          meta: {
            title: 'Fun Portfolio',
            description:
              'Side projects by Catherine Luse: Multiforum, AI Beta Reader, and Clockwork Town.'
          }
        },
        {
          path: 'blog',
...
const setMeta = (key: string, content: string, attr: 'name' | 'property') => {
